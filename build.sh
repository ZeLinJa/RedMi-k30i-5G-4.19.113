...
# 仓库分支
KERNEL_SOURCE_BRANCH=picasso-r-oss
# CPU类型
export ARCH=arm64
# 配置文件
...
SOURCE_BOOT_IMAGE=https://github.com/ZeLinJa/KernelSU_Action-main/blob/b7134848524dab197d9f1e09f4f4c7dd2ddc7411/boot/boot.img
